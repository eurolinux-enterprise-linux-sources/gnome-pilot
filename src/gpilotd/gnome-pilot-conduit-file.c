...
#line 30 "gnome-pilot-conduit-file.gob"
...
#line 34 "gnome-pilot-conduit-file.c"
/* self casting macros */
...
#define __GOB_FUNCTION__ "Gnome:Pilot:Conduit:File::class_init"
	...
	if ___GOB_UNLIKELY(sizeof(int ) != sizeof(gint ) || sizeof(int ) != sizeof(gint ) || sizeof(gchar * ) != sizeof(gpointer ) || sizeof(gboolean ) != sizeof(gboolean ) || parent_class == NULL /* avoid warning */) {
		g_error("gnome-pilot-conduit-file.gob line 52: Type mismatch of \"install_db\" signal signature");
	}
...
#line 43 "gnome-pilot-conduit-file.gob"
GtkObject * 
gnome_pilot_conduit_file_new (GPilotPilot * pilot)
#line 189 "gnome-pilot-conduit-file.c"
{
#define __GOB_FUNCTION__ "Gnome:Pilot:Conduit:File::new"
{
#line 44 "gnome-pilot-conduit-file.gob"
...
#line 200 "gnome-pilot-conduit-file.c"
#undef __GOB_FUNCTION__

#line 52 "gnome-pilot-conduit-file.gob"
int 
gnome_pilot_conduit_file_install_db (GnomePilotConduitFile * self, int pisock, gchar * src_file, gboolean rm)
#line 206 "gnome-pilot-conduit-file.c"
{
...
#line 218 "gnome-pilot-conduit-file.c"
